...
/// ```
public struct AnyLLMSettingsView: View {
    @EnvironmentObject private var store: ConfigurationStore
    @Environment(\.anyLLMProvidersOverride) private var providersOverride
    @Environment(\.anyLLMProviderFilter) private var providerFilter
    @Environment(\.anyLLMRegistry) private var registry
